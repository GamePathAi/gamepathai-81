...
import { Facebook, Mail, Lock, User, AlertCircle, Check } from "lucide-react";
...
export function SignupForm() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      // This is a mock signup - in a real app, you would call your authentication API
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      toast.success("Account created successfully", {
        description: "Welcome to GamePath AI"
      });
  ...
  const handleSocialSignup = async (provider: string) => {
    ...
    try {
      ...
      toast.error(`${provider} signup failed`, {
        description: "Please try again or use another signup method"
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <form onSubmit={handleEmailSignup} className="space-y-3">
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 ${errors.name ? 'border-cyber-red' : ''}`}
              value={name}
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input
              ...
              type="password"
              placeholder="••••••••"
              className={`pl-10 ${errors.confirmPassword ? 'border-cyber-red' : ''}`}
        ...
        <div className="flex items-start space-x-2 pt-2">
          <Checkbox 
            ...
            className={errors.agreeTerms ? "border-cyber-red" : ""}
          />
          <div>
            <label
              htmlFor="terms"
            ...
            >
              I agree to the{" "}
              <a href="/terms" className="text-cyber-blue hover:underline">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="/privacy" className="text-cyber-blue hover:underline">
                Privacy Policy
              </a>
            </label>
            {errors.agreeTerms && (
              <p className="text-cyber-red text-xs flex items-center mt-1">
                <AlertCircle className="h-3 w-3 mr-1" /> {errors.agreeTerms}
              </p>
            )}
          </div>
        </div>
