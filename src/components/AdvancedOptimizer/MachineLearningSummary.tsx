  ...
  return (
    <div className="space-y-6">
            ...
            <CardContent>
              ...
              <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-cyber-darkblue rounded-md p-3 border border-cyber-purple/20">
                  <div className="text-xs text-gray-500 mb-1">Learning Progress</div>
                ...
                <div className="bg-cyber-darkblue rounded-md p-3 border border-cyber-blue/20">
                  <div className="text-xs text-gray-500 mb-1">Games Analyzed</div>
                ...
                <div className="bg-cyber-darkblue rounded-md p-3 border border-cyber-pink/20">
                  ...
                  <div className="text-lg font-tech text-cyber-pink">High</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="space-y-4">
              <div className="bg-cyber-darkblue rounded-md p-3 border border-cyber-blue/20">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-sm font-tech text-cyber-blue">CPU Thread Optimization</div>
                </div>
                ...
                <div className="flex justify-between mt-1">
                  ...
                  <span className="text-xs text-cyber-blue">78%</span>
                </div>
              </div>
              ...
              <div className="bg-cyber-darkblue rounded-md p-3 border border-cyber-green/20">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-sm font-tech text-cyber-green">Memory Timing Profile</div>
                </div>
                <p className="text-xs text-gray-400 mb-2">
              ...
              <div className="bg-cyber-darkblue rounded-md p-3 border border-cyber-purple/20">
                ...
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-gray-500">Confidence</span>
                  <span className="text-xs text-cyber-purple">85%</span>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <Card className="cyber-card border-cyber-blue/30">
        <CardHeader className="pb-2">
          <h3 className="text-lg font-tech flex items-center">
            <Clock className="mr-2 text-cyber-blue" size={18} />
